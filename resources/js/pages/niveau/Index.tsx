                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow className="bg-muted">
                                            ...
                                            <TableHead className="float-end pr-10">
                                                Actions
                                            </TableHead>
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody>
                                        {niveaux.data.map((niveau) => (
                                            <TableRow>
                                                ...
                                                <TableCell className="float-end flex place-items-center gap-2">
                                                    <Link
                                                    ...
                                                    <Link
                                                        ...
                                                        className="cursor-pointer rounded-md bg-yellow-500 p-1 text-sm text-white hover:bg-yellow-500/80"
                                                    >
                                                        Emploi Du Temps
                                                    </Link>
                                                </TableCell>
